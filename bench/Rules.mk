...
$(d)client: $(OBJS-spec-client) $(OBJS-pbft-client) $(OBJS-tombft-client) $(OBJS-minbft-client)
$(d)client: $(OBJS-unreplicated-sig-client)
...
$(d)replica: $(OBJS-unreplicated-sig-replica)
