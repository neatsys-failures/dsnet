...
$(d)client:	$(OBJS-vr-client) $(OBJS-fastpaxos-client) $(OBJS-unreplicated-client) $(OBJS-nopaxos-client) $(OBJS-hydranopaxos-client)
$(d)client: $(OBJS-spec-client) $(OBJS-pbft-client) $(OBJS-tombft-client)

$(d)replica: $(o)replica.o $(LIB-udptransport) $(LIB-dpdktransport)
$(d)replica: $(OBJS-vr-replica) $(OBJS-fastpaxos-replica) $(OBJS-unreplicated-replica) $(OBJS-nopaxos-replica) $(OBJS-hydranopaxos-replica)
